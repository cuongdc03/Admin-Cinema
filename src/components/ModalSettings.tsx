      ...
      <div className='modal overflow-auto rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
        <div className='border-b border-stroke px-7 py-4 dark:border-strokedark'>
          <div className='flex w-full justify-end'>
            <strong className='align-center cursor-pointer text-xl ' onClick={closeModal}>
              &times;
            </strong>
          </div>
          <form>
            ...
            <br></br>
            <button
              className='btn flex justify-center rounded bg-primary px-6 py-2 font-medium text-gray hover:shadow-1'
              type='submit'
