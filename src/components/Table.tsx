...
const TableTest: React.FC<TableTestProps<any>> = ({ rows, onDelete, onStatusChange, displayedColumns, isCinema }) => {
      ...
      <div className={`fixed inset-0 z-50 flex items-center justify-center ${showModal ? 'block' : 'hidden'}`}>
        <div className="bg-white rounded-lg shadow-lg p-6 w-96">
          ...
          <div className="flex justify-between">
            <button onClick={handleCancelDelete} className="bg-blue-400 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded">
              Cancel
            </button>
